...
> The version `0.4.142` is the only version that is dual published as `vite-plugin-ssr@0.4.142`/`vike@0.4.142`, enabling you to migrate to `vike` simply applying this bash script.
